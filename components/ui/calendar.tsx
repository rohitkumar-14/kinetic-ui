    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "[&:has(.day-range-end)]:bg-accent/50 [&:has(.day-range-end)]:rounded-r-md",
          "[&:has(.day-range-start)]:bg-accent/50 [&:has(.day-range-start)]:rounded-l-md",
        ...
        range_middle:
          "aria-selected:bg-accent aria-selected:text-accent-foreground day-range-middle bg-accent/50 text-accent-foreground",
        hidden: "invisible",
        ...classNames,
      }}
      components={{
